...
parser.add_argument('--result_file', default='generated_results.json', help='dialog result file (.json)')
parser.add_argument('--hypout_file', default='generated_results_hyp.json', help='output hypothesis file (.json)')
